...
launcher = "none"
load_from = "/home/ana/University/Tamgi/src/mmdetection/work_dirs/yolov3_mobilenetv2_8b24_320_300e_coco_tamgi/best_coco_bbox_mAP_epoch_270.pth"
log_level = "INFO"
...
model = dict(
    backbone=dict(
        ...
        init_cfg=dict(checkpoint="open-mmlab://mmdet/mobilenet_v2", type="Pretrained"),
        out_indices=(
            2,
            4,
            6,
...
work_dir = "./work_dirs/yolov3_mobilenetv2_8b24_320_300e_coco_tamgi"
