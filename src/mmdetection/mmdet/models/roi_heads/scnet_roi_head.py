...
class SCNetRoIHead(CascadeRoIHead):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        super().__init__(
            num_stages=num_stages, stage_loss_weights=stage_loss_weights, **kwargs
        )
    ...
    def init_mask_head(
        self, mask_roi_extractor: ConfigType, mask_head: ConfigType
    ) -> None:
    ...
    def _fuse_glbctx(
        self, roi_feats: Tensor, glbctx_feat: Tensor, rois: Tensor
    ) -> Tensor:
    ...
    def _slice_pos_feats(
        self, feats: Tensor, sampling_results: List[SamplingResult]
    ) -> Tensor:
    ...
    def _bbox_forward(
        ...
        bbox_results = dict(
            cls_score=cls_score, bbox_pred=bbox_pred, relayed_feat=relayed_feat
        )
        return bbox_results
    ...
    def _mask_forward(
        ...
        semantic_feat: Optional[Tensor] = None,
        glbctx_feat: Optional[Tensor] = None,
        relayed_feat: Optional[Tensor] = None,
    ) -> dict:
    ...
    def bbox_loss(
        ...
        bbox_results = self._bbox_forward(
            stage, x, rois, semantic_feat=semantic_feat, glbctx_feat=glbctx_feat
        )
    ...
    def semantic_loss(self, x: Tuple[Tensor], batch_data_samples: SampleList) -> dict:
    ...
    def global_context_loss(
        self, x: Tuple[Tensor], batch_gt_instances: InstanceList
    ) -> dict:
        """Global context loss.
        ...
        global_context_results = dict(loss_glbctx=loss_glbctx, glbctx_feat=glbctx_feat)

        return global_context_results

    def loss(
        self, x: Tensor, rpn_results_list: InstanceList, batch_data_samples: SampleList
    ) -> dict:
        ...
        if self.with_feat_relay:
            relayed_feat = self._slice_pos_feats(
                bbox_results["relayed_feat"], sampling_results
            )
        ...
        losses["loss_mask"] = (
            mask_stage_loss_weight * mask_results["loss_mask"]["loss_mask"]
        )
