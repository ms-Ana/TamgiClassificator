...
launcher = "none"
load_from = "/home/ana/University/Tamgi/src/mmdetection/work_dirs/cascade_rcnn_r50_fpn_tamgi/best_coco_bbox_mAP_epoch_34.pth"
log_level = "INFO"
...
work_dir = "./work_dirs/cascade_rcnn_r50_fpn_tamgi"
