...
def main():
    ...
    for corr_i, corruption in enumerate(corruptions):
        ...
        for sev_i, corruption_severity in enumerate(args.severities):
            ...
            if corr_i > 0 and corruption_severity == 0:
                aggregated_results[corruption][0] = aggregated_results[corruptions[0]][
                    0
                ]
                continue
            ...
            if corruption_severity > 0:
                corruption_trans = dict(
                    type="Corrupt", corruption=corruption, severity=corruption_severity
                )
    ...
    if rank == 0:
        ...
        if cfg.dataset_type == "VOCDataset":
            get_results(
                eval_results_filename, dataset="voc", prints=prints, aggregate=aggregate
            )
        else:
            get_results(
                eval_results_filename,
